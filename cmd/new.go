...
var newCmd = &cobra.Command{
	Use:   "new",
	Short: "Create a new stuff such as registered targets",
	Long: `Create a new stuff such as registered targets.
For example:

	tempest new --target --autoGen /tmp
	# This will generate a new directory in /tmp called "temp.est" and register it
	  as a target.
`,
